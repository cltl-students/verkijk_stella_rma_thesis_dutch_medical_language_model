...
def completeDataframe(data): 
    ...
    df['domain'][df['labels'].apply(lambda x: '.D840-859: Beroep en werk' in x)] = '.D840-859: Beroep en werk'
    df['domain'][df['labels'].apply(lambda x: '.B152: Stemming' in x)] = '.B152: Stemming'
    df['level'][df['labels'].apply(lambda x: 'STM 0' in x)] = 0
    df['level'][df['labels'].apply(lambda x: 'STM 1' in x)] = 1
    df['level'][df['labels'].apply(lambda x: 'STM 2' in x)] = 2
    df['level'][df['labels'].apply(lambda x: 'STM 3' in x)] = 3
    df['level'][df['labels'].apply(lambda x: 'STM 4' in x)] = 4
    df['level'][df['labels'].apply(lambda x: 'STM 5' in x)] = 5
    df['level'][df['labels'].apply(lambda x: 'FAC 0' in x)] = 0
    df['level'][df['labels'].apply(lambda x: 'FAC 1' in x)] = 1
    df['level'][df['labels'].apply(lambda x: 'FAC 2' in x)] = 2
    df['level'][df['labels'].apply(lambda x: 'FAC 3' in x)] = 3
    df['level'][df['labels'].apply(lambda x: 'FAC 4' in x)] = 4
    df['level'][df['labels'].apply(lambda x: 'FAC 5' in x)] = 5
    df['level'][df['labels'].apply(lambda x: 'INS 0' in x)] = 0
    df['level'][df['labels'].apply(lambda x: 'INS 1' in x)] = 1
    df['level'][df['labels'].apply(lambda x: 'INS 2' in x)] = 2
    df['level'][df['labels'].apply(lambda x: 'INS 3' in x)] = 3
    df['level'][df['labels'].apply(lambda x: 'INS 4' in x)] = 4
    df['level'][df['labels'].apply(lambda x: 'INS 5' in x)] = 5
    df['level'][df['labels'].apply(lambda x: 'BER 0' in x)] = 0
    df['level'][df['labels'].apply(lambda x: 'BER 1' in x)] = 1
    df['level'][df['labels'].apply(lambda x: 'BER 2' in x)] = 2
    df['level'][df['labels'].apply(lambda x: 'BER 3' in x)] = 3
    df['level'][df['labels'].apply(lambda x: 'BER 4' in x)] = 4
    df['level'][df['labels'].apply(lambda x: 'BER 5' in x)] = 5
    
    #'FAC 0', 'STM 0', 'BER 0', 'INS 0'
