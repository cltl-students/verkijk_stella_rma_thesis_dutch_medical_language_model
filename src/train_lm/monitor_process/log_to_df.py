...
def main(logdir_or_logfile: str, filename: str, write_pkl: bool, write_csv: bool, out_dir: str):
...
# to run: 
#log_to_df.py xx/yy/events.out.tfevents.1566371516.VTD2-PC filename --write-csv --no-write-pkl -o converted
#or
